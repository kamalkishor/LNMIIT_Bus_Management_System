...
<form method=POST action = reserve.php>	<?php
...
echo "<tr>"."<td style='color: #000' width='150px'>"."$S_no"."</td>"."<td width='50px' style='color: #000'>"."$Institute"."<input type=radio name=abc value=$busI>"."</td>"."<td style='color: #000' width='200px'>"."$Ajmeri_gate"."<input type=radio  name=abc value=$busA>"."</td>"."</tr>";
	}
	?>
